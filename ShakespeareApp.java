...
class ShakespeareApp implements ActionListener
  {  
   JLabel displayLabel;
   JButton nextButton;
   JButton prevButton;
   ...
   ShakespeareApp()
     {  
      try
        {
         shakeResources = ResourceBundle.getBundle("resources.Shakespeare",Locale.getDefault());
        }
      ...
      JFrame jfrm = new JFrame(shakeResources.getString("Title"));  
      ...
      prevButton = new JButton(shakeResources.getString("Prev"));
      prevButton.setActionCommand("Prev");
      buttonPanel.add(prevButton);
      prevButton.addActionListener(this);
      
      nextButton = new JButton(shakeResources.getString("Next"));
      ...
      clips.load("ShakespeareClips.clp");
   ...
   private void nextUIState() throws Exception
     {
      ...
      if (fv.getFactSlot("state").toString().equals("final"))
        { 
         ...
         nextButton.setText(shakeResources.getString("Restart")); 
         prevButton.setVisible(true);
        }
      else if (fv.getFactSlot("state").toString().equals("initial"))
        {
         nextButton.setActionCommand("Next");
         nextButton.setText(shakeResources.getString("Next"));
      ...
      for (int i = 0; i < pv.size(); i++) 
        {
         ...
         if (bv.toString().equals(selected))
            { rButton = new JRadioButton(shakeResources.getString(bv.toString()),true); }
         else
            { rButton = new JRadioButton(shakeResources.getString(bv.toString()),false); }
      ...
      String theText = shakeResources.getString(fv.getFactSlot("display").symbolValue());
   ...
   public static void main(String args[])
     {  
      ...
      SwingUtilities.invokeLater(
        new Runnable() 
          {  
           public void run() { new ShakespeareApp(); }  
          });   
     }  
  }